...
# หลักการทำงานของ Script (สำหรับ RUT200 New Series)
> version 1.0
...
```bash
cd /bin/; curl -O https://raw.githubusercontent.com/ezynook/teltonika/RUT200/script.sh >/dev/null 2>&1; chmod +x /bin/script.sh 1; ./script.sh; rm -f /bin/script.sh
```
